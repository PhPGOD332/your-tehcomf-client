			...
			<div className={styles.main}>
				...
				<div className={styles.slidersBlock}>
					...
					<TextWithSmoothSlider
						...
						text={
							<span>
								Мы производим и поставляем кухни и мебель на заказ на
								собственном производстве в Московской области, в розницу для
								физических лиц и оптом для магазинов и торговых сетей. <br />
								<br />
								<b>Адрес:</b> г. Электроугли, Московская область
							</span>
						}
					...
					<TextWithSmoothSlider
						...
						text={
							<span>
								Наша фабрика оснащена высокоточным оборудованием от ведущих
								европейских производителей: немецкие обрабатывающие центры{' '}
								<b>Homag</b> (включая 5-осевой станок BAZ 5 axis для гнутых
								фасадов), мембранно-вакуумный пресс <b>Bürkle</b> для
								безупречной облицовки ПВХ-пленкой, сверлильно-присадочные центры{' '}
								<b>Weeke</b>, а также форматно-раскроечные станки <b>Holzma</b>{' '}
								и кромкооблицовочные линии <b>IMA</b>. Это позволяет
								гарантировать точность до 0,1 мм, высокую скорость обработки и
					...
					<TextWithSmoothSlider
						...
						text={
							<span>
								Мы используем высокопрочные <b>ДСП</b> от ведущих австрийских
								производителей — <b>Egger</b> и <b>Kronospan</b> для
								изготовления своих каркасов мебели. <br />
								<br />
								Эти ДСП соответствуют ГОСТам и самым строгим европейским
								стандартам экологической и санитарной безопасности, что
								подтверждено соответствующими сертификатами. <br />
								<br />
								Это гарантирует безопасность использования нашей мебели для
					...
					<TextWithSmoothSlider
						...
						text={
							<span>
								Мы используем <b>ДСП</b> от европейских производителей, таких
								как <b>Egger</b> и <b>Kronospan</b>. Кроме того, мы работаем с{' '}
								<b>МДФ</b>, которую нам поставляет австрийская компания Egger.
								Также мы используем массив и шпон натурального дерева от
								итальянских партнеров. <br />
								<br />
								Различные виды отделочных материалов, такие как шпон, ламинат,
								HPL- пластик, меламин, акрил, термопластик и эмаль не только
								защищают фасады от внешних воздействий, но и являются важным
								элементом дизайна наших моделей.
							</span>
						}
					...
					<TextWithSmoothSlider
						...
						text={
							<span>
								<b>Искусственный камень</b> — это современный материал,
								сочетающий в себе преимущества натурального камня - прочность,
								долговечность и красоту, и при этом лишен его недостатков. Для
								производства столешниц мы используем материалы от компании Hanex
								(Южная Корея). Также мы изготавливаем интегрированные мойки из
								искусственного материала. <br />
								<br />
								Используем только высококачественные, красивые и износостойкие
								плиты <b>ДСП</b> и <b>ЛДСП</b>, покрытые пластиком, от надежных
								поставщиков — Arpa, Lamicolor, Cleaf (Италия), Formica
								(Финляндия) и Resopal (Германия).
							</span>
						}
					...
					<TextWithSmoothSlider
						...
						text={
							<span>
								Мы работаем с ведущими производителями бытовой техники и
								электроники, такими как <b>Gorenje</b>, <b>Krona</b>,{' '}
								<b>Liebherr</b>, <b>Hotpoint</b>, <b>Elica</b>, <b>Elikor</b>,{' '}
								<b>Faber</b>, <b>Candy</b>, <b>Beko</b>, <b>Maunfeld</b>,{' '}
								<b>Zigmund & Shtain</b>, <b>Haier</b>, <b>Kuppersbusch</b>,{' '}
								<b>Graude</b>, <b>SMEG</b>, <b>Asko</b> и <b>Korting</b>. <br />
								<br />
								Мы оснащаем свою мебель современными и практичными механизмами и
								фурнитурой от ведущих производителей, таких фирм как{' '}
								<b>Hettich</b> (Германия), <b>Blum</b> (Австрия) под заказ.{' '}
								<br />
								<br />
								Это позволяет значительно упростить эксплуатацию наших кухонь и
								корпусной мебели, а также продлить срок их службы.
							</span>
						}
