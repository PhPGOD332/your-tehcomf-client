			...
			<div className={'container'}>
				<div className={styles.wrapper}>
					<div className={styles.mapBlock}>
						<SubTitle classNames={styles.title} as={titleAs}>
							Контакты
						</SubTitle>
						<div className={styles.map}>
							<div style={{ position: 'relative', overflow: 'hidden' }}>
								...
								>
									Шарикоподшипниковская улица, 4к4А — Яндекс Карты
								</a>
								<iframe
							...
							<tbody>
								...
								<tr className={styles.tableRow}>
									...
									<td className={styles.tableTextContent}>
										<span className={styles.tableMainText}>
											Москва, <br className={styles.transfer} />{' '}
											Шарикоподшипниковская улица, 4,{' '}
											<br className={styles.transfer} /> корп. 4А
										</span>
										<br />
								...
								<tr className={`${styles.tableRowOneCol} ${styles.tableNote}`}>
									<td className={styles.tableTextNote}>
										...
										поможем подобрать идеальную мебель, ответим на все вопросы и
										предложим лучшие условия покупки!
									</td>
								</tr>
							</tbody>
						</table>
